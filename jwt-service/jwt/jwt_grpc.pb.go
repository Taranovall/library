// Code generated by protoc-gen-go-grpc-handlers. DO NOT EDIT.
// versions:
// - protoc-gen-go-grpc-handlers v1.2.0
// - protoc             v4.25.3
// source: jwt.proto
...
// is compatible with the grpc-handlers package it is being compiled against.
...
// It's only intended for direct use with grpc-handlers.RegisterService,
